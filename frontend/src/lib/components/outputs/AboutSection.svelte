<div class="card border-l-4 border-l-nvidia-green-500">
	<h2 class="text-base font-semibold text-gray-900 mb-3">About This Experiment</h2>
	...
	<div class="border-t border-gray-100 mt-4 pt-4 text-sm text-gray-500">
		Built by <span class="font-medium text-gray-700">Victor Zhang</span>
		<span class="mx-1">·</span>
		<a
			href="https://www.linkedin.com/in/victor-yuchi-zhang/"
			target="_blank"
			rel="noopener noreferrer"
			class="inline-flex items-center gap-1 text-gray-500 hover:text-nvidia-green-600 transition-colors"
		>
			LinkedIn
